...
const BLAI_KO = {
  ...
  right: {
    ...
    desc: "BLAI(Blog AI)는 네이버 블로그 운영자를 위한 분석 및 최적화 SaaS입니다. 키워드 분석, 형태소/비속어 분석, 이미지 분석, AI 리라이팅 등 다양한 분석 도구를 제공합니다. 웹 서비스 4개(사용자 웹, API 서버, Python 분석 서버, 관리자)와 외부 도구 2개(크롬 확장, 데스크톱 이미지 에디터)로 구성된 마이크로서비스 아키텍처로 운영되고 있습니다.",
    navigation: {
      title: "맡은 역할",
      value: [
        {
